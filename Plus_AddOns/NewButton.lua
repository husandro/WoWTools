...
local function Init_NotDisabled_Button()
    ...
    function btn:set_tooltips()
        ...
        e.tips:AddDoubleLine(format('%s|TInterface\\AddOns\\WoWTools\\z_Sesource\\Texture\\WoWtools.tga:0|t|cffff00ffWoW|r|cff00ff00Tools|r', e.onlyChinese and '启用' or ENABLE, ''), e.GetYesNo(Save().enableAllButtn))
        e.tips:Show()
        self:SetAlpha(1)
    end
