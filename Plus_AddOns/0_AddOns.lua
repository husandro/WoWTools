        ...
        if arg1==id then
            ...
            e.AddPanel_Check({
                ...
                SetValue= function()
                    ...
                    print(e.addName, WoWTools_AddOnsMixin.addName, e.GetEnabeleDisable(not Save().disabled), e.onlyChinese and '需求重新加载' or REQUIRES_RELOAD)
                end
            })
