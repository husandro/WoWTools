...
local function Init(Frame)
    ...
    notUseColorCheck:SetScript('OnMouseDown', function()
        ...
        useClassColorCheck:SetChecked(false)
        print(WoWTools_DataMixin.Icon.icon2..WoWTools_CursorMixin.addName, WoWTools_TextMixin:GetEnabeleDisable(not Save().disabled), WoWTools_Mixin.onlyChinese and '需要重新加载' or REQUIRES_RELOAD)
    end)
