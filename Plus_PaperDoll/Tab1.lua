...
--物品等级
    ...
    LabelPvE:SetScript('OnEnter', function(self)
        ...
        GameTooltip:AddLine(' ')
        GameTooltip:AddLine('|cnGREEN_FONT_COLOR:'..format(WoWTools_Mixin.onlyChinese and '物品等级：%d' or CHARACTER_LINK_ITEM_LEVEL_TOOLTIP, self.avgItemLevel or ''))
...
--PvP物品等级
    ...
    LabelPvP:SetScript('OnEnter', function(self)
        ...
        GameTooltip:AddLine(CharacterStatsPane.ItemLevelFrame.tooltip2)
        GameTooltip:AddLine(' ')
        GameTooltip:AddLine('|cnGREEN_FONT_COLOR:'..format(WoWTools_Mixin.onlyChinese and 'PvP物品等级 %d' or ITEM_UPGRADE_PVP_ITEM_LEVEL_STAT_FORMAT, self.avgItemLevel or '0'))
        --GameTooltip:AddDoubleLine(WoWTools_Mixin.addName, WoWTools_PaperDollMixin.addName)
        GameTooltip:Show()
        self:SetAlpha(0)
    end)
