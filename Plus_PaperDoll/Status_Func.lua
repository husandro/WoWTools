...
local function Init()
    ...
    function CharacterStatsPane.ItemLevelFrame.Value:set_tooltips()
        ...
        GameTooltip:AddLine(' ')
        GameTooltip:AddDoubleLine((e.onlyChinese and '小数点 ' or 'bit ')..(Save().itemLevelBit==-1 and '|cnRED_FONT_COLOR:'..(e.onlyChinese and '禁用' or DISABLE)..'|r' or ('|cnGREEN_FONT_COLOR:'..Save().itemLevelBit)), '-1'..e.Icon.left)
        GameTooltip:AddDoubleLine(' ', '+1'..e.Icon.right)
        GameTooltip:AddLine('-1 '..(e.onlyChinese and '禁用' or DISABLE))
        GameTooltip:Show()
    end
