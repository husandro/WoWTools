...
local function Init()
    ...
    function btn2:set_tooltips()
        ...
        GameTooltip:AddDoubleLine((e.onlyChinese and '自动输入 ‘忘却’' or (TRADE_SKILLS ..': '..UNLEARN_SKILL_CONFIRMATION))..e.GetEnabeleDisable(Save().wangquePrefessionText), (e.onlyChinese and '双击' or BUFFER_DOUBLE)..e.Icon.left)
        GameTooltip:AddLine(' ')
        GameTooltip:AddLine(e.onlyChinese and '你确定要忘却%s并遗忘所有已经学会的配方？如果你选择回到此专业，你的专精知识将依然存在。|n|n在框内输入 \"忘却\" 以确认。' or UNLEARN_SKILL, nil,nil,nil, true)
        GameTooltip:AddLine(' ')
