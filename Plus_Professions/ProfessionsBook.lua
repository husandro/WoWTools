...
local function Init()
    ...
    function btn2:set_tooltips()
        ...
        GameTooltip:AddDoubleLine((WoWTools_Mixin.onlyChinese and '自动输入 ‘忘却’' or (TRADE_SKILLS ..': '..UNLEARN_SKILL_CONFIRMATION))..e.GetEnabeleDisable(Save().wangquePrefessionText), (WoWTools_Mixin.onlyChinese and '双击' or BUFFER_DOUBLE)..e.Icon.left)
        GameTooltip:AddLine(' ')
