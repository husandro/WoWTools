...
local function Init()
    ...
    check.Text:SetText(WoWTools_Mixin.onlyChinese and '目标' or TARGET)
    ...
    check:SetScript('OnEnter', function(self)
        ...
        GameTooltip:AddLine(' ')
        GameTooltip:AddDoubleLine(WoWTools_Mixin.onlyChinese and '自动要求签名' or  format(GARRISON_FOLLOWER_NAME, SELF_CAST_AUTO, REQUEST_SIGNATURE), WoWTools_Mixin.onlyChinese and '目标' or TARGET)
        GameTooltip:Show()
    end)
