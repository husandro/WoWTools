...
function WoWTools_TooltipMixin:Set_Item(tooltip, itemLink, itemID)
    ...
    tooltip.textRight:SetText('|cffffffff'..WoWTools_Mixin:MK(net-bag, 3)..'|A:questlog-questtypeicon-account:0:0|a'..WoWTools_Mixin:MK(wowNum, 3)..e.Icon.wow2..' '..WoWTools_Mixin:MK(bank, 3)..'|A:Banker:0:0|a'..' '..WoWTools_Mixin:MK(bag, 3)..'|A:bag-main:0:0|a')
