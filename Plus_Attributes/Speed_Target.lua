...
local function Init()
    ...
    function btn:set_tooltip()
        ...
        e.tips:ClearLines()
        e.tips:AddDoubleLine(WoWTools_AttributesMixin.addName, '|A:common-icon-rotateright:0:0|a'..(e.onlyChinese and '目标移动' or format(CLUB_FINDER_LOOKING_FOR_CLASS_SPEC, TARGET, NPE_MOVE)))
        e.tips:AddLine(' ')
