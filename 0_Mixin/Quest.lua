...
function WoWTools_QuestMixin:GetQuestAll()
    ...
    GameTooltip:AddLine(' ')
    GameTooltip:AddLine(WoWTools_QuestMixin:GetColor('Day').hex..(WoWTools_Mixin.onlyChinese and '日常' or DAILY)..': '..dayNum)
    GameTooltip:AddLine(WoWTools_QuestMixin:GetColor('Week').hex..(WoWTools_Mixin.onlyChinese and '周长' or WEEKLY)..': '..weekNum)
    GameTooltip:AddLine((num>=MAX_QUESTS and '|cnRED_FONT_COLOR:' or '|cffffffff')..(WoWTools_Mixin.onlyChinese and '一般' or RESISTANCE_FAIR)..': '..numQuest..'/'..MAX_QUESTS)
    GameTooltip:AddLine(' ')
    GameTooltip:AddLine(WoWTools_QuestMixin:GetColor('Legendary').hex..(WoWTools_Mixin.onlyChinese and '传说' or GARRISON_FOLLOWER_QUALITY6_DESC)..': '..legendaryNum)
    GameTooltip:AddLine(WoWTools_QuestMixin:GetColor('Legendary').hex..(WoWTools_Mixin.onlyChinese and '战役' or TRACKER_HEADER_CAMPAIGN_QUESTS)..': '..campaignNum)
    GameTooltip:AddLine(WoWTools_QuestMixin:GetColor('Legendary').hex..(WoWTools_Mixin.onlyChinese and '悬赏' or PVP_BOUNTY_REWARD_TITLE)..': '..bountyNum)
    GameTooltip:AddLine(WoWTools_QuestMixin:GetColor('Legendary').hex..(WoWTools_Mixin.onlyChinese and '故事' or 'Story')..': '..storyNum)
    GameTooltip:AddLine((WoWTools_Mixin.onlyChinese and '追踪' or TRACK_QUEST_ABBREV)..': '..C_QuestLog.GetNumQuestWatches())
end
