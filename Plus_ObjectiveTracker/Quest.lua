...
local function Init()
    WoWTools_ObjectiveTrackerMixin:Add_ClearAll_Button(QuestObjectiveTracker, WoWTools_Mixin.onlyChinese and '任务' or TRACKER_HEADER_QUESTS, function(self)
...
function WoWTools_ObjectiveTrackerMixin:Init_Quest()
    Init()
end