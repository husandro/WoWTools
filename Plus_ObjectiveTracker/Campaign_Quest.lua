...
local function Init()
    WoWTools_ObjectiveMixin:Add_ClearAll_Button(CampaignQuestObjectiveTracker, WoWTools_Mixin.onlyChinese and '战役' or TRACKER_HEADER_CAMPAIGN_QUESTS, function(self)
