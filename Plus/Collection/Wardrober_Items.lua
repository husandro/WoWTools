...
local SlotsIcon = {
    ...
    "|A:transmog-gearSlot-unassigned-back:0:0|a",--3
    "|A:transmog-gearSlot-unassigned-chest:0:0|a",--4
    "|A:transmog-gearSlot-unassigned-shirt:0:0|a",--5
    "|A:transmog-gearSlot-unassigned-tabard:0:0|a",--6
    "|A:transmog-gearSlot-unassigned-wrist:0:0|a",--7
    "|A:transmog-gearSlot-unassigned-hands:0:0|a",--8
...
local function UpdateSlotButtons(self)
    if not self:IsVisible() or not self.SlotsFrame.Buttons then
        return
    end
            ...
            if self.transmogLocation:IsIllusion() then--武器，附魔            
                ...
                if all>0 then
                    GameTooltip:AddLine(
                        ...
                        ..format('|A:transmog-gearSlot-unassigned-enchant:0:0|a%i%%  %d/%d', collected/all*100, collected, all)
                    )
                end
