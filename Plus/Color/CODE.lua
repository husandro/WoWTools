...
"DAMAGE_METER_STATUS_BAR_CREATURE_COLOR",
"DAMAGE_METER_STATUS_BAR_DEFAULT_COLOR",
"DARKGRAY_COLOR",
...
"ENCOUNTER_TIMELINE_BLOCKED_TEXT_COLOR",
"ENCOUNTER_TIMELINE_PAUSED_TEXT_COLOR",
"ENCOUNTER_TIMELINE_QUEUED_TEXT_COLOR",
"ENCOUNTER_TIMELINE_SPELL_NAME_COLOR",
"ENCOUNTER_TIMELINE_TIMER_COLOR",
"ENCOUNTER_WARNINGS_CRITICAL_FONT_COLOR",
"ENCOUNTER_WARNINGS_MEDIUM_FONT_COLOR",
"ENCOUNTER_WARNINGS_MINOR_FONT_COLOR",
...
"HOUSING_CONTROL_PANEL_TITLE",
"HOUSING_EXPERT_CONTROL_TEXT_COLOR",
"HOUSING_EXTERIOR_COMPONENT_HOVER",
"HOUSING_HEADER_COLOR",
"HOUSING_LAYOUT_BLUEPRINT_EDGE_COLOR",
"HOUSING_LAYOUT_BLUEPRINT_TINT_COLOR",
"HOUSING_PLACEMENT_GRID_INVALID_COLOR",
"HOUSING_PLACEMENT_GRID_ROOM_CROSS_COLOR",
"HOUSING_PLACEMENT_GRID_VALID_COLOR",
"HOUSING_REWARD_TOAST_LABEL_FONT_COLOR",
"HOUSING_REWARD_TOAST_LABEL_FONT_COLOR",
"HOUSING_ROOM_COMPONENT_HOVER",
"HOUSING_STORAGE_HEADER_COLOR",
...
"MIDNIGHT_PARCHMENT_ACCESSIBILITY_RED",
"NAMEPLATE_BORDER_FOCUS_TARGET_COLOR",
"NAMEPLATE_BORDER_TARGET_COLOR",
...
"PARCHMENT_ACCESSIBILITY_GREEN",
"PARCHMENT_ACCESSIBILITY_RED",
    ...
    for index, name in pairs(Tab) do
        ...
        if type(color)=='table' and color.GetRGB then
           ...
           sub:AddInitializer(function(btn, desc)
                ...
                icon:SetSize(14, 14)
                icon:SetPoint("RIGHT", bg, -1, 0)
                icon:SetColorTexture(_G[desc.data.name]:GetRGB())

                local label= btn:AttachFontString()
                label:SetPoint('RIGHT', -18, 0)
                label:SetTextColor(DISABLED_FONT_COLOR:GetRGB())
                label:SetJustifyH('RIGHT')
                label:SetText(desc.data.rightText)

                return btn.fontString:GetUnboundedStringWidth()+20+label:GetUnboundedStringWidth()+5, 20
            end)
...
local function Init(edit)
    ...
    local btn= CreateFrame('DropdownButton', 'WoWToolsColorCodeMenuButton', edit, 'WoWToolsMenu3Template') --WoWTools_ButtonMixin:Menu(edit, {atlas='AnimaChannel-Bar-Necrolord-Gem'})
    btn:SetNormalAtlas('AnimaChannel-Bar-Necrolord-Gem')
