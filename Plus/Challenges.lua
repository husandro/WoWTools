...
e.ChallengesSpellTabs={--C_MythicPlus.GetCurrentSeason()
    ...
    [403]= {spell=393222, ins=1197, name='奥达曼', spellName='看护者遗产之路', spellDes='传送到|cff00ccff奥达曼|r：|cffff00ff提尔的遗产|r的入口。'},--传送到奥达曼：提尔的遗产的入口 看护者遗产之路
    ...
    [2]={spell=131204, ins=313, name='青龙之路', spellDes='将施法者传送到|cff00ccff青龙寺|r入口。'},
    ...
    --[392]={spell=367416, ins=1194, name='天街', spellName='街头商贩之路', spellDes='传送至|cff00ccff塔扎维什，帷纱集市|r入口处。'},
    [166]={spell=159900, ins=536, name='恐轨车站', spellName='暗轨之路', spellDes='传送至|cff00ccff恐轨车站|r入口处。'},
    --[369]={spell=373274, ins=1178, name='麦卡贡', spellName='机械王子之路', spellDes='传送到|cff00ccff麦卡贡|r行动的入口。'},
