...
local function Init()
    ...
    WoWTools_ColorMixin:SetLabelColor(QuestButton.Text)

    QuestButton.Text:SetPoint('RIGHT', QuestButton, 'LEFT', 0, 1)

--Bg
    _G['WoWToolsGossipButton'].Background:SetPoint('LEFT', QuestButton.Text, -1, 0)
    ...
    function check:set_tooltip()
        GameTooltip:SetOwner(self, "ANCHOR_LEFT")
        GameTooltip_SetTitle(GameTooltip, WoWTools_GossipMixin.addName2..WoWTools_DataMixin.Icon.icon2)
