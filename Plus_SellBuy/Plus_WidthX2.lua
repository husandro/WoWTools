...
local function Init_WidthX2()
    if C_AddOns.IsAddOnLoaded("CompactVendor") then
        print(WoWTools_Mixin.addName, WoWTools_SellBuyMixin.addName, format(e.onlyChinese and "|cffff0000与%s发生冲突！|r" or ALREADY_BOUND, 'CompactVendor'), e.onlyChinese and '插件' or ADDONS)
    end
