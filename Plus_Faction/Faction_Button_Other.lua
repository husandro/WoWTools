...
local function Init()
	...
	down:SetScript('OnEnter', function(self)
		...
		GameTooltip:AddDoubleLine(' ', e.onlyChinese and '展开选项|A:editmode-down-arrow:16:11:0:-7|a' or HUD_EDIT_MODE_EXPAND_OPTIONS)
	...
	up:SetScript('OnEnter', function(self)
		GameTooltip:SetOwner(self, "ANCHOR_LEFT")
		GameTooltip:ClearLines()
		GameTooltip:AddDoubleLine(' ', e.onlyChinese and '收起选项|A:editmode-up-arrow:16:11:0:3|a' or HUD_EDIT_MODE_COLLAPSE_OPTIONS)
		GameTooltip:AddDoubleLine(WoWTools_Mixin.addName, WoWTools_FactionMixin.addName)
		GameTooltip:Show()
	end)

	local edit= WoWTools_EditBoxMixin:Create(up, {name='WoWTools_PlusFactionSearchBox', instructions= e.onlyChinese and '搜索' or SEARCH, Template='SearchBoxTemplate'})
