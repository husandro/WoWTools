...
local function Create_WorldBoss_Button(frame)
    ...
    function btn:set_tooltip()
        ...
        GameTooltip:AddDoubleLine(WoWTools_DataMixin.onlyChinese and '冒险指南' or ADVENTURE_JOURNAL, WoWTools_DataMixin.onlyChinese and '副本' or INSTANCE)
        GameTooltip:AddLine(' ')
        ...
        GameTooltip:AddDoubleLine(WoWTools_DataMixin.onlyChinese and '字体大小' or FONT_SIZE, (Save().InsFontSize or 12)..WoWTools_DataMixin.Icon.mid)
        GameTooltip:Show()
    end
