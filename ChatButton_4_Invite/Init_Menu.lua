...
--reload
    ...
    root:CreateDivider()
    sub=root:CreateButton(format('%s|A:talents-button-reset:0:0|a%s %d', WoWTools_Mixin.onlyChinese and '拒绝' or DECLINE, WoWTools_Mixin.onlyChinese and '邀请' or INVITE, Save().InvNoFriendNum or 0))
