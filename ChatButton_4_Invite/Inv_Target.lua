...
local function Init()
    ...
    function frame:InviteTarget()
        ...
        print(e.Icon.icon2..WoWTools_InviteMixin.addName, WoWTools_Mixin.onlyChinese and '目标' or TARGET, WoWTools_UnitMixin:GetPlayerInfo(nil, guid, name, {reLink=true}))
    end
