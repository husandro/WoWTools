...
--保存
    ...
    if index then
        ...
        sub=root:CreateButton(e.onlyChinese and '保存' or SAVE, function() return MenuResponse.Open end)
    end
...
--新建, 列表内容
        ...
        sub2:SetTooltip(function(tooltip, description)
            ...
            if description.data.tab.body then
                ...
                tooltip:AddLine(' ')
                tooltip:AddLine('|cnGREEN_FONT_COLOR:'..'|A:communities-chat-icon-plus:0:0|a'..(e.onlyChinese and '新建' or NEW)..e.Icon.left)
            else
