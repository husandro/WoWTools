...
function WoWTools_TextureMixin.Frames:QuestFrame()
    ...
    self:SetUIButton(QuestLogPopupDetailFrameAbandonButton)
    self:SetUIButton(QuestLogPopupDetailFrameShareButton)
    self:SetUIButton(QuestLogPopupDetailFrameTrackButton)
...
--社交，按钮
    ...
    for _, name in pairs({
        ...
        if btn then
            ...
            self:SetAlphaColor(btn:GetNormalTexture(), nil, nil, 0.5)
...
function WoWTools_TextureMixin.Frames:CatalogShopFrame()--Blizzard_CatalogShop
    ...
    self:SetAlphaColor(CatalogShopFrame.HeaderFrame.Background, nil, true, 0.3)
    self:SetAlphaColor(CatalogShopFrame.HeaderFrame.CatalogShopNavBar.ScrollForwards.NormalTexture, nil, true, 0.3)
    self:SetAlphaColor(CatalogShopFrame.HeaderFrame.CatalogShopNavBar.ScrollBackwards.NormalTexture, nil, true, 0.3)

    self:SetAlphaColor(CatalogShopFrame.ForegroundContainer.Foreground, nil, true, 0.7)
