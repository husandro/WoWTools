...
local function set_Button_Text()
    ...
    for index, info in pairs(allTable) do
        ...
        if not btn then
            btn= WoWTools_ButtonMixin:Cbtn(Button.Frame, {size={12,12}, icon='hdie'})
        ...
        for questID, _ in pairs(Save.questIDs) do
            ...
            info={
                ...
                func= function(_, arg1)
                    ...
                    print(e.addName, Initializer:GetName(), e.cn(addName2), GetQuestLink(questID) or questID,
        ...
        for areaPoiID, uiMapID in pairs(Save.areaPoiIDs) do
            ...
            info={
                ...
                func= function(_, arg1,arg2)
                    ...
                    print(e.addName,Initializer:GetName(), e.cn(addName2),
...
local function Init_Set_Button()--小地图, 标记, 文本
    ...
    Button= WoWTools_ButtonMixin:Cbtn(nil, {icon='hide', size={18,18}, isType2=true})
    Button.btn={}
    ...
    function Button:speak_Text(text)
        ...
        print(e.addName, e.cn(addName2),'|cffff00ff', text)
    end
    ...
    Button:SetScript('OnMouseWheel', function(self, d)--缩放
        if IsAltKeyDown() then
            ...
            print(e.addName, Initializer:GetName(), e.onlyChinese and '缩放' or UI_SCALE, scale)
    ...
    local SetTrackingButton= WoWTools_ButtonMixin:Cbtn(WorldMapFrame, {size={20,20}, icon='hide'})
...
local function Blizzard_TimeManager()
    ...
    TimeManagerClockButton:HookScript('OnMouseWheel', function(self, d)
        ...
        self:set_scale()
        print(e.addName, Initializer:GetName(), '|cnGREEN_FONT_COLOR:', n)
    end)
    --时钟，移动
