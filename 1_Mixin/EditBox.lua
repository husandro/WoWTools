...
function WoWTools_EditBoxMixin:CreateFrame(frame, tab)
    ...
    scrollFrame.ScrollToBottomButton= CreateFrame('Button', nil, scrollFrame.ScrollBar)
    scrollFrame.ScrollToBottomButton:SetSize(17,15)
    scrollFrame.ScrollToBottomButton:SetPoint('TOP', scrollFrame.ScrollBar, 'BOTTOM')
    scrollFrame.ScrollToBottomButton:SetNormalAtlas('minimal-scrollbar-arrow-returntobottom')
    scrollFrame.ScrollToBottomButton:SetPushedAtlas('minimal-scrollbar-arrow-returntobottom-down')
    scrollFrame.ScrollToBottomButton:SetHighlightAtlas('minimal-scrollbar-arrow-returntobottom-over')
    --scrollFrame.ScrollToBottomButton:SetDisabledAtlas('minimal-scrollbar-arrow-returntobottom')

    WoWTools_TextureMixin:SetButton(scrollFrame.ScrollToBottomButton)
    scrollFrame.ScrollToBottomButton:SetScript('OnMouseDown', function(b)
        b:GetParent():ScrollToEnd()
    end)

    scrollFrame.ScrollToBeginButton= CreateFrame('Button', nil, scrollFrame.ScrollBar)
    scrollFrame.ScrollToBeginButton:SetSize(17,15)
    scrollFrame.ScrollToBeginButton:SetPoint('BOTTOM', scrollFrame.ScrollBar, 'TOP')
    scrollFrame.ScrollToBeginButton:SetNormalAtlas('minimal-scrollbar-arrow-returntobottom')
    scrollFrame.ScrollToBeginButton:SetPushedAtlas('minimal-scrollbar-arrow-returntobottom-down')
    scrollFrame.ScrollToBeginButton:SetHighlightAtlas('minimal-scrollbar-arrow-returntobottom-over')
    --scrollFrame.ScrollToBeginButton:SetDisabledAtlas('minimal-scrollbar-arrow-returntobottom')
    scrollFrame.ScrollToBeginButton:GetNormalTexture():SetTexCoord(0,1,1,0)
    scrollFrame.ScrollToBeginButton:GetPushedTexture():SetTexCoord(0,1,1,0)
    scrollFrame.ScrollToBeginButton:GetHighlightTexture():SetTexCoord(0,1,1,0)
    --scrollFrame.ScrollToBeginButton:GetDisabledTexture():SetTexCoord(0,1,1,0)
    WoWTools_TextureMixin:SetButton(scrollFrame.ScrollToBeginButton)
    scrollFrame.ScrollToBeginButton:SetScript('OnMouseDown', function(b)
